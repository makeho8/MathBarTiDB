...
import materials.discrete_math.content.manager as content_mgr
import materials.discrete_math.quiz.manager as quiz_mgr
import materials.discrete_math.slides.manager as slides_mgr
